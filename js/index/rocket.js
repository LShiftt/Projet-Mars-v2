...
let scWing = document.querySelector("input[name=color_wing]"),
    ...
    if (localStorage.getItem("fenetre") && localStorage.getItem("corps") && localStorage.getItem("ailerons")) {
        scBody.value = localStorage.getItem("corps");
        scWindow.value = localStorage.getItem("fenetre");
        scWing.value = localStorage.getItem("ailerons");
    }
